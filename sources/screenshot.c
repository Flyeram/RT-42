...
/*   Updated: 2016/06/29 16:18:24 by Rakiah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	tga_header(char *buffer, t_texture *tex)
{
	...
	buffer[i++] = (tex->width & 0x00FF); buffer[i++] = (tex->width & 0xFF00) / 256;
	buffer[i++] = (tex->height & 0x00FF); buffer[i++] = (tex->height & 0xFF00) / 256;
	buffer[i++] = 24;
	buffer[i++] = 0;
}
